...
| <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/actions/annotate.svg" width="20" alt="Annotate"> / <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/actions/menu-paste.svg" width="20" alt="MenuPaste"> | Re-run the last import with the previously chosen source and options. The document icon indicates file-based imports; the clipboard icon appears when the last import used clipboard data. |
| <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/debugger/attachToProcess.svg" width="20" alt="Attach"> / <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/actions/restartDebugger.svg" width="20" alt="RestartDebugger"> | Attach the current tab to a chosen IntelliJ run configuration and stream its output live. Once attached, the icon changes to a detach indicator (restart debugger) so you can disconnect quickly. |
| <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/expui/fileTypes/addAny.svg" width="20" alt="AddAny"> / <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/fileTypes/any_type.svg" width="20" alt="AnyType"> | Tail an external file and push new lines directly into the active GrobTree tab. While a file is attached, the icon turns into the filled document so you know the tailer is active. |
| <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/debugger/threadRunning.svg" width="20" alt="ThreadRunning"> / <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/debugger/threadFrozen.svg" width="20" alt="ThreadFrozen"> | Toggle automatic evaluation for newly started run configurations (live attach on/off). The icon flips to the pause glyph when GrobTree is currently following a live process. |
...
| <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/actions/find.svg" width="20" alt="Find"> / <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/actions/findEntireFile.svg" width="20" alt="FindEntireFile"> | Open the search box scoped to the current GrobTree tab. When search is already active, the icon shows the filled magnifier. |
| <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/actions/show.svg" width="20" alt="Show"> / <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/actions/toggleVisibility.svg" width="20" alt="ToggleVisibility"> | Remove active filters so every processed entry is displayed again. While “show all” is enabled, the icon changes to the reveal eye. |
...
| <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/ide/notification/ideUpdate.svg" width="20" alt="IdeUpdate"> / <img src="https://intellij-icons.jetbrains.design/icons/AllIcons/ide/notification/pluginUpdate.svg" width="20" alt="PluginUpdate"> | Reapply the configuration defaults to the current tab when GrobTree detects changes. If nothing needs updating, the icon reverts to the greyed plugin badge. |

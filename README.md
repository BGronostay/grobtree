...
1. **Install the plugin** – Grab the latest ZIP from the [release page](https://github.com/bgronostay/grobtree/releases/latest) and install it via *Settings → Plugins → ⚙ → Install Plugin from Disk…* (IntelliJ IDEA 2025.1+).
